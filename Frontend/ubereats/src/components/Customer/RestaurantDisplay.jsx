  ...
  return(
    <Fragment>
     ...
     (
       ...
       <div className="card-footer" style={{backgroundColor:"black",textAlign:"center"}}>
          <button type="button" className="btn btn-link" onClick={()=>{getRestaurantLanding(res._id,res.restaurantName)}} style={{color:"white",textDecoration:"none",padding:"0"}}><h5 className="card-title" style={{backgroundColor:"black", width:"400px",height:"200px"}}>{`${res.restaurantName}`}</h5></button>
       </div>
        </div>
          </Col>
        )
