  ...
  return(
    <div className="restaurant-NavBar" style={{position:"fixed",top:0,width:"100%",zIndex:"100"}}>
      ...
      <ul className="nav justify-content-end">
        ...
        <a className="nav-link active" aria-current="page" href="http://13.56.184.154:3000/PastOrders">Past orders</a>
        </li>
        <li className="nav-item">
        <a className="nav-link active" aria-current="page" href="http://13.56.184.154:3000/CustomerLandingPage">Looking for food?</a>
        </li>
        <li className="nav-item">
        <a className="nav-link active" aria-current="page" href="http://13.56.184.154:3000/CustomerPage">{JSON.parse(localStorage.getItem("user"))["name"]}<span style={{color:"green"}}> ,View Account</span></a>
        </li>
        <li className="nav-item">
